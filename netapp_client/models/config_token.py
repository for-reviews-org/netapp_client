...
class ConfigToken(object):
    ...
    @property
    def expires(self):
        """Gets the expires of this ConfigToken.  # noqa: E501

        time when the token expires  # noqa: E501

        :return: The expires of this ConfigToken.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expires(self, expires):
        """Sets the expires of this ConfigToken.

        time when the token expires  # noqa: E501

        :param expires: The expires of this ConfigToken.  # noqa: E501
        :type: datetime
        """
        if expires is None:
