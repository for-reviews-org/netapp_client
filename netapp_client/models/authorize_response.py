...
class AuthorizeResponse(Response):
    ...
    @property
    def data(self):
        """Gets the data of this AuthorizeResponse.  # noqa: E501

        authorization bearer token  # noqa: E501

        :return: The data of this AuthorizeResponse.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this AuthorizeResponse.

        authorization bearer token  # noqa: E501

        :param data: The data of this AuthorizeResponse.  # noqa: E501
        :type: str
        """
        if data is None:
