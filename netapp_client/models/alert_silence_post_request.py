...
class AlertSilencePostRequest(object):
    ...
    def __init__(self, end_time=None, comment=None, maximum_severity=None, matchers=None):  # noqa: E501
        """AlertSilencePostRequest - a model defined in Swagger"""  # noqa: E501
        self._end_time = None
        self._comment = None
    ...
    @property
    def end_time(self):
        """Gets the end_time of this AlertSilencePostRequest.  # noqa: E501

        the time the silence will stop suppressing notifications  # noqa: E501

        :return: The end_time of this AlertSilencePostRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this AlertSilencePostRequest.

        the time the silence will stop suppressing notifications  # noqa: E501

        :param end_time: The end_time of this AlertSilencePostRequest.  # noqa: E501
        :type: datetime
        """
        if end_time is None:
    ...
    @property
    def comment(self):
        """Gets the comment of this AlertSilencePostRequest.  # noqa: E501

        a comment to describe the silence  # noqa: E501

        :return: The comment of this AlertSilencePostRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this AlertSilencePostRequest.

        a comment to describe the silence  # noqa: E501

        :param comment: The comment of this AlertSilencePostRequest.  # noqa: E501
        :type: str
        """
    ...
    def maximum_severity(self):
        """Gets the maximum_severity of this AlertSilencePostRequest.  # noqa: E501
        ...
        :return: The maximum_severity of this AlertSilencePostRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def maximum_severity(self, maximum_severity):
        """Sets the maximum_severity of this AlertSilencePostRequest.

        the maximum severity level for silences. For example, \"major\" will silence minor and major alerts, but will not silence critical alerts.  # noqa: E501

        :param maximum_severity: The maximum_severity of this AlertSilencePostRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def matchers(self):
        """Gets the matchers of this AlertSilencePostRequest.  # noqa: E501
        ...
        :return: The matchers of this AlertSilencePostRequest.  # noqa: E501
    ...
    def matchers(self, matchers):
        """Sets the matchers of this AlertSilencePostRequest.

        Optionally, one or more name/value pairs used to match an alert's labels. An alert is silenced if all specified name/value pairs match its labels. If no name/value pairs are specified, all alerts are silenced, based on the other filtering criteria.  # noqa: E501

        :param matchers: The matchers of this AlertSilencePostRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlertSilencePostRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertSilencePostRequest):
            return False
